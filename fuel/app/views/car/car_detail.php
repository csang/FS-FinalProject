		...
		<div class="carId">
			<div class="top">
				<div class="idAvatarMask">
					<?= Html::anchor('profile/profile.php', Asset::img('avatar.jpg', array('class' => 'idAvatar'))) ?>
				</div>
				<div class="mainInfo">
					<div class="left">
						<div class="names">
							<select>
								<option value="1">Honda Accord 2006</option>
								<option value="2" selected>Honda Accord 2008</option>
								<option value="3">Honda Accord 2010</option>
							</select>
						</div>
					</div>
				</div>
